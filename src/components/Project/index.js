                    ...
                    HTML5 - CSS3 - Bootstrap - ReactJS
                            ...
                            <div className="col-sm-2">
                                <div className="w-like">
                                    <a className="git-icon" href="https://github.com/luan-tran-89/cs516" target="_blank"
                ...
                <div className="work-box">
                  ...
                  <span className="w-ctegory">
                    ...
                    Hive - Visualization with Tableau
                            ...
                            <div className="col-sm-2">
                                <div className="w-like">
                                    <a className="git-icon" href="https://github.com/luan-tran-89/cs523" target="_blank"
                                       rel="noopener noreferrer">
                                        <i className="ion-social-github"></i>
                                    </a>
                                </div>
                ...
                <div className="work-box">
                  ...
                  <span className="w-ctegory">
                    ...
                    Swagger - Circuit Breaker Pattern
                            ...
                            <div className="col-sm-2">
                                <div className="w-like">
                                    <a className="git-icon" href="https://github.com/EA-course-MIU/Movie-Rating-Portal"
